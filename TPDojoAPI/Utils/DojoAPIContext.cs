...
namespace TPDojoAPI.Utils
{
    public class DojoAPIContext : DbContext
    {
        public DojoAPIContext(DbContextOptions options) : base(options)
        {
        }

        protected DojoAPIContext()
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Samourai>().HasIndex(s => s.Arme).IsUnique();
            int id = 100;
            Random r = new Random();
